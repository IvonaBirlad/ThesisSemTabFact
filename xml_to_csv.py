...
trial_files = sorted(glob.glob('C:/Users/ivona/Desktop/MSc Thesis/sem-tab-fact-main/sem-tab-fact-main/xml/train_manual_v1.3.2/v1.3.2/output/*.xml'))
...
with open(TSV_FOLDER + 'trial_set.tsv', 'w') as tsvfile:
	tsv_writer = csv.DictWriter(tsvfile, delimiter='\t', fieldnames=header)
	tsv_writer.writeheader()
	table_idx = 1
	for file in tqdm(trial_files):
		with open(file, encoding="utf-8") as f:
			table_idx = read_xml(f, table_idx, tsv_writer, 'trial_')
